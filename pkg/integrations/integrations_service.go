...
func (api *IntegrationsService) getConfig() *torboxapiconfig.Config {
...
func (api *IntegrationsService) AuthenticateOauth(ctx context.Context, apiVersion string, provider string) (*shared.TorboxApiResponse[any], *shared.TorboxApiError) {
	config := *api.getConfig()

	request := httptransport.NewRequestBuilder().WithContext(ctx).
		WithMethod("GET").
		WithPath("/{api_version}/api/integration/oauth/{provider}").
		WithConfig(config).
		AddPathParam("api_version", apiVersion).
		AddPathParam("provider", provider).
...
func (api *IntegrationsService) QueueGoogleDrive(ctx context.Context, apiVersion string) (*shared.TorboxApiResponse[any], *shared.TorboxApiError) {
	config := *api.getConfig()

	request := httptransport.NewRequestBuilder().WithContext(ctx).
		WithMethod("POST").
		WithPath("/{api_version}/api/integration/googledrive").
		WithConfig(config).
...
//
// Requires an API key using the Authorization Bearer Header.
func (api *IntegrationsService) QueueOnedrive(ctx context.Context, apiVersion string) (*shared.TorboxApiResponse[any], *shared.TorboxApiError) {
	config := *api.getConfig()

	request := httptransport.NewRequestBuilder().WithContext(ctx).
		WithMethod("POST").
		WithPath("/{api_version}/api/integration/onedrive").
		WithConfig(config).
		AddHeader("CONTENT-TYPE", "application/json").
		AddPathParam("api_version", apiVersion).
		WithContentType(httptransport.ContentTypeJson).
...
//
// Requires an API key using the Authorization Bearer Header.
func (api *IntegrationsService) QueueGofile(ctx context.Context, apiVersion string) (*shared.TorboxApiResponse[any], *shared.TorboxApiError) {
	config := *api.getConfig()

	request := httptransport.NewRequestBuilder().WithContext(ctx).
		WithMethod("POST").
		WithPath("/{api_version}/api/integration/gofile").
		WithConfig(config).
		AddHeader("CONTENT-TYPE", "application/json").
		AddPathParam("api_version", apiVersion).
		WithContentType(httptransport.ContentTypeJson).
...
//
// Requires an API key using the Authorization Bearer Header.
func (api *IntegrationsService) Queue1fichier(ctx context.Context, apiVersion string) (*shared.TorboxApiResponse[any], *shared.TorboxApiError) {
	config := *api.getConfig()

	request := httptransport.NewRequestBuilder().WithContext(ctx).
		WithMethod("POST").
		WithPath("/{api_version}/api/integration/1fichier").
		WithConfig(config).
		AddHeader("CONTENT-TYPE", "application/json").
		AddPathParam("api_version", apiVersion).
		WithContentType(httptransport.ContentTypeJson).
...
//
// Requires an API key using the Authorization Bearer Header.
func (api *IntegrationsService) GetAllJobs(ctx context.Context, apiVersion string) (*shared.TorboxApiResponse[GetAllJobsOkResponse], *shared.TorboxApiError) {
	config := *api.getConfig()

	request := httptransport.NewRequestBuilder().WithContext(ctx).
		WithMethod("GET").
		WithPath("/{api_version}/api/integration/jobs").
		WithConfig(config).
		AddPathParam("api_version", apiVersion).
		WithContentType(httptransport.ContentTypeJson).
		WithResponseContentType(httptransport.ContentTypeJson).
	...
	client := restClient.NewRestClient[GetAllJobsOkResponse](config)
	resp, err := client.Call(*request)
	if err != nil {
		return nil, shared.NewTorboxApiError[GetAllJobsOkResponse](err)
	}

	return shared.NewTorboxApiResponse[GetAllJobsOkResponse](resp), nil
}
...
//
// Requires an API key using the Authorization Bearer Header.
func (api *IntegrationsService) GetSpecificJob(ctx context.Context, apiVersion string, jobId string) (*shared.TorboxApiResponse[[]byte], *shared.TorboxApiError) {
	config := *api.getConfig()
...
//
// Requires an API key using the Authorization Bearer Header.
func (api *IntegrationsService) GetAllJobsByHash(ctx context.Context, apiVersion string, hash string) (*shared.TorboxApiResponse[GetAllJobsByHashOkResponse], *shared.TorboxApiError) {
	config := *api.getConfig()

	request := httptransport.NewRequestBuilder().WithContext(ctx).
		WithMethod("GET").
		WithPath("/{api_version}/api/integration/jobs/{hash}").
		WithConfig(config).
		AddPathParam("api_version", apiVersion).
		AddPathParam("hash", hash).
		WithContentType(httptransport.ContentTypeJson).
		WithResponseContentType(httptransport.ContentTypeJson).
		Build()

	client := restClient.NewRestClient[GetAllJobsByHashOkResponse](config)
	resp, err := client.Call(*request)
	if err != nil {
		return nil, shared.NewTorboxApiError[GetAllJobsByHashOkResponse](err)
	}

	return shared.NewTorboxApiResponse[GetAllJobsByHashOkResponse](resp), nil
}
