...
func (g *GetUserDataOkResponse) GetError() *util.Nullable[any] {
	if g == nil {
		return nil
	}
	return g.Error
...
func (g *GetUserDataOkResponse) SetError(error util.Nullable[any]) {
	g.Error = &error
}

func (g *GetUserDataOkResponse) SetErrorNull() {
